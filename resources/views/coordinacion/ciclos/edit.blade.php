<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="mt-0.5 text-xl font-bold text-utec-gray-dark">Editar ciclo académico</h2>
                <p class="text-sm text-gray-400">Actualiza la información del ciclo seleccionado.</p>
            </div>
