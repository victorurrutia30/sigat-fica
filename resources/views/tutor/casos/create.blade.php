<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="mt-0.5 text-xl font-bold text-utec-gray-dark">Agregar estudiante</h2>
                <p class="text-sm text-gray-400">Registra un estudiante no evaluado para seguimiento.</p>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('casos.store') }}">
                        @include('tutor.casos._form', ['textoBoton' => 'Agregar estudiante'])
                    </form>
                </div>
            </div>
        </div>
